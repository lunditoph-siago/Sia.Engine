...
public sealed class ShadowGpuStore
{
    ...
    public void Refresh(World world, ShadowAtlasConfig config, Entity cameraEntity)
    {
        ...
        var cameraTransform = cameraEntity.Get<GlobalTransform>().Affine;
        ...
        world.Query(_spotMatcher, entity => {
            ...
            var viewProj = CascadeSplitting.ComputeSpotViewProj(in worldTransform, light.OuterAngle, light.Range);
