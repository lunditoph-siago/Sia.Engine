...
{
    public static PbrRenderFeatureOptions FromProfile(RenderProfile profile)
    {
        ArgumentNullException.ThrowIfNull(profile);
        profile.Validate();
        return new() { ScreenSpaceReflections = profile.ScreenSpaceReflections,
            ScreenSpaceIndirectLighting = profile.ScreenSpaceIndirectLighting };
    }
