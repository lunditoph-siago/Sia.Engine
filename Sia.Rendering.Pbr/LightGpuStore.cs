...
public sealed class LightGpuStore
{
    ...
    public void Refresh(World world, ShadowGpuStore? shadows = null)
    {
        ...
        world.Query(_directionalMatcher, entity => {
            ...
            var forward = -math.normalize(entity.Get<GlobalTransform>().Affine.RotationScale.c2);
        ...
        world.Query(_pointMatcher, entity => {
            var position = entity.Get<GlobalTransform>().Affine.Translation;
        ...
        world.Query(_spotMatcher, entity => {
            ...
            var direction = -math.normalize(worldTransform.RotationScale.c2);
